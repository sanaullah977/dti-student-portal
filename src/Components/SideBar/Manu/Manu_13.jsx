    ...
    return (
      <div className="card bg-base-100 shadow-xl border border-teal-100 p-8 max-w-2xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-gray-600 mb-6">
          Your request for <strong>S. Sc Marksheet Received Copy</strong> has been received. Reference ID: <span className="font-mono text-teal-600 font-bold">REF-SSCR-{Math.floor(100000 + Math.random() * 900000)}</span>
        </p>
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800">S. Sc Marksheet Received (Copy)</h2>
          <p className="text-gray-500 text-sm">Apply to retrieve a copy of your submitted SSC marksheet from the academic archive.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card bg-base-100 shadow-md border border-gray-200 p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Education Board</span></label>
            <select 
              name="board" 
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">SSC Passing Year</span></label>
            <input 
              type="number" 
              name="passingYear" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Upload Acknowledgment/Clearance Slip (Optional)</span></label>
            <input 
              type="file" 
        ...
        <div className="form-control">
          <label className="label"><span className="label-text font-semibold text-gray-600">Remarks</span></label>
          <textarea 
            name="details" 
            value={formData.details} 
            onChange={handleChange} 
            placeholder="Add any specific details if you have (e.g. date when you submitted the original marksheets)..." 
