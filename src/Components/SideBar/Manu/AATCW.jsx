...
const AATCW = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    studentId: '',
    department: 'CSE',
    withdrawalType: 'Official Transcript',
    passingYear: '2025',
    cgpa: '',
    email: '',
    phone: '',
    ...
    return (
      <div className="card bg-base-100 shadow-xl border border-teal-100 p-8 max-w-2xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-gray-600 mb-6">
          Your request for <strong>Academic Transcript & Certificate Withdrawal</strong> has been received. Reference ID: <span className="font-mono text-teal-600 font-bold">REF-WDR-{Math.floor(100000 + Math.random() * 900000)}</span>
        </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 text-left mb-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-y-2 text-sm text-gray-600">
            ...
            <span className="font-medium">Document Type:</span> <span>{formData.withdrawalType}</span>
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Academic Transcript & Certificate Withdrawal</h2>
          <p className="text-gray-500 text-sm">Request withdrawal of official academic transcript, provisional, or main certificates.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card bg-base-100 shadow-md border border-gray-200 p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Withdrawal Document Type</span></label>
            <select 
              name="withdrawalType" 
            ...
            >
              ...
              <option value="Main Degree Certificate">Main Degree Certificate</option>
              <option value="All Documents">All Documents (Withdrawal)</option>
            </select>
          </div>
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Final CGPA</span></label>
            <input 
              type="number" 
              step="0.01" 
              min="2.00" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Upload Department Clearance Certificate</span></label>
            <input 
              type="file" 
              required
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Upload Library Clearance Copy</span></label>
            <input 
              type="file" 
              required
              className="file-input file-input-bordered w-full rounded-xl text-sm"
        ...
        <div className="form-control">
          <label className="label"><span className="label-text font-semibold text-gray-600">Reason for Withdrawal</span></label>
          <textarea 
            name="reason" 
            value={formData.reason} 
            onChange={handleChange} 
            placeholder="State why you are requesting to withdraw the documents (e.g. Job selection, Higher study admission)..." 
