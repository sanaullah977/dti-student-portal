    ...
    return (
      <div className="card bg-base-100 shadow-xl border border-teal-100 p-8 max-w-2xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-gray-600 mb-6">
          Your request for <strong>Course Complete Certificate</strong> has been received. Reference ID: <span className="font-mono text-teal-600 font-bold">REF-CCC-{Math.floor(100000 + Math.random() * 900000)}</span>
        </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 text-left mb-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-y-2 text-sm text-gray-600">
            ...
            <span className="font-medium">Semesters Completed:</span> <span>{formData.semestersCompleted}</span>
            <span className="font-medium">Total Credits Completed:</span> <span>{formData.totalCredits}</span>
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Apply for Course Complete Certificate</h2>
          <p className="text-gray-500 text-sm">Request a certificate verifying you have successfully completed all degree requirements.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card bg-base-100 shadow-md border border-gray-200 p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Semesters Completed</span></label>
            <input 
              type="number" 
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Total Credits Earned</span></label>
            <input 
              type="number" 
              name="totalCredits" 
        ...
        <div className="form-control">
          <label className="label"><span className="label-text font-semibold text-gray-600">Upload Final Semester Grade Sheet</span></label>
          <input 
            type="file" 
            required
        ...
        <div className="form-control">
          <label className="label"><span className="label-text font-semibold text-gray-600">Purpose / Reason</span></label>
          <textarea 
            name="reason" 
            value={formData.reason} 
            onChange={handleChange} 
            placeholder="Please detail what you require the certificate for..." 
