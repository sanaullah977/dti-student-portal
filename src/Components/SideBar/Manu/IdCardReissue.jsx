    ...
    return (
      <div className="card bg-base-100 shadow-xl border border-teal-100 p-8 max-w-2xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-gray-600 mb-6">
          Your request for <strong>ID Card Re-issue</strong> has been received. Reference ID: <span className="font-mono text-teal-600 font-bold">REF-IDC-{Math.floor(100000 + Math.random() * 900000)}</span>
        </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 text-left mb-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-y-2 text-sm text-gray-600">
            ...
            {formData.reason === 'Lost' && (
              <>
                <span className="font-medium">GD Number:</span> <span>{formData.gdNumber}</span>
              </>
            )}
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800">ID Card Re-issue Form</h2>
          <p className="text-gray-500 text-sm">Apply for a replacement student ID card in case of loss, theft, damage, or correction.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card bg-base-100 shadow-md border border-gray-200 p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {formData.reason === 'Lost' && (
            <div className="form-control">
              <label className="label"><span className="label-text font-semibold text-gray-600">GD Entry Number (Police)</span></label>
              <input 
                type="text" 
                name="gdNumber" 
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Payment Transaction ID (Fee: 200 BDT)</span></label>
            <input 
              type="text" 
              name="transactionId" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {formData.reason === 'Lost' && (
            <div className="form-control">
              <label className="label"><span className="label-text font-semibold text-gray-600">Upload Police GD Copy (PDF/Image)</span></label>
              <input 
                type="file" 
                required
          ...
          <div className="form-control">
            <label className="label"><span className="label-text font-semibold text-gray-600">Upload Recent Passport Size Photo</span></label>
            <input 
              type="file" 
              required
              className="file-input file-input-bordered w-full rounded-xl text-sm"
        ...
        <div className="form-control">
          ...
          <textarea 
            ...
            onChange={handleChange} 
            placeholder="Add any specific details if you chose Info Correction (e.g. correct spellings of your name)..." 
